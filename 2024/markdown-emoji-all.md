...
This cheat sheet WAS ORIGINALLY automatically generated from [GitHub Emoji API](https://api.github.com/emojis) and [Unicode Full Emoji List](https://unicode.org/emoji/charts/full-emoji-list.html).
<details open>
...
<summary><strong>Smileys & Emotion</strong></summary>
...
We use the [CommonMark Emoji Extension](https://github.com/giberti/commonmark-emoji-extension) by @giberti on GitHub (Erik Giberti) to render our emojis and as you can there are quite a few missing?
